...
![Colour Scheme](documentation/images/color_scheme.png)
...
### known Bugs
On the Register page, I noticed some errors during validation, but they don't seem to affect the app, and none of the users have complained about anything. I believe these error are generated by Django.
